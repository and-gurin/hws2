...
function Clock() {
    ...
    const stringDate = `${date.getFullYear()}:${date.getMonth()}:${date.getDate()}` || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
