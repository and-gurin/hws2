...
const initialPeople: UserType[] = [
    {_id: 0, name: 'Cat Arnold', age: 3},
    {_id: 1, name: 'Joe Biden', age: 66},
    {_id: 2, name: 'Gretta Tunberg', age: 16},
    {_id: 3, name: 'Justin Timberlake', age: 44},
    {_id: 4, name: 'Alice Cooper', age: 40},
    {_id: 5, name: 'Moby', age: 55},
]
...
const HW8 = () => {
    ...
    return (
        <div id={'hw3'}>
            <div className={s2.hwTitle}>Super sort</div>
            <div className={s2.hw}>
