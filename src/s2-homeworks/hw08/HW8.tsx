...
const initialPeople: UserType[] = [
    ...
    {_id: 0, name: 'Кот Матроскин', age: 3},
    {_id: 1, name: 'Александр Розенбаум', age: 66},
    {_id: 2, name: 'Коля Герасимов', age: 16},
    {_id: 3, name: 'Виктор Цой', age: 44},
    {_id: 4, name: 'Дмитрий Нагиев', age: 40},
    {_id: 5, name: 'Ирина Салтыкова', age: 55},
]
